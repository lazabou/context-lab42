...
| R1-R11 | 10.0.111.0/30  | R1 10.0.111.1| R11 10.0.111.2|
| R2-R11 | 10.0.211.0/30  | R2 10.0.211.1| R11 10.0.211.2|
| R3-R12 | 10.0.312.0/30  | R3 10.0.312.1| R12 10.0.312.2|

### Interface mapping (Docker)

| Container | eth0 (mgmt)      | eth1            | eth2            | eth3          |
|-----------|------------------|-----------------|-----------------|---------------|
| r1        | 192.168.100.1/24 | 10.0.12.1 → R2  | 10.0.13.1 → R3  | 10.0.111.1 → R11 |
| r2        | 192.168.100.2/24 | 10.0.12.2 → R1  | 10.0.23.1 → R3  | 10.0.211.1 → R11 |
| r3        | 192.168.100.3/24 | 10.0.13.2 → R1  | 10.0.23.2 → R2  | 10.0.312.1 → R12 |
| r11       | 192.168.100.11/24| 10.0.111.2 → R1 | 10.0.211.2 → R2 | —             |
| r12       | 192.168.100.12/24| 10.0.312.2 → R3 | —               | —             |
