...
docker network create --subnet 10.1.11.0/30 net-r1-r11     2>/dev/null || echo "net-r1-r11 already exists"
docker network create --subnet 10.2.11.0/30 net-r2-r11     2>/dev/null || echo "net-r2-r11 already exists"
docker network create --subnet 10.3.12.0/30 net-r3-r12     2>/dev/null || echo "net-r3-r12 already exists"
...
docker network connect --ip 10.1.11.1 net-r1-r11 r1
...
docker network connect --ip 10.2.11.1 net-r2-r11 r2
...
docker network connect --ip 10.3.12.1 net-r3-r12 r3
...
docker create --privileged --name r11 \
  ...
  --hostname R11 \
  ${CRPD_IMAGE}
docker network connect --ip 10.1.11.2 net-r1-r11 r11
docker network connect --ip 10.2.11.2 net-r2-r11 r11
...
docker create --privileged --name r12 \
  ...
  --hostname R12 \
  ${CRPD_IMAGE}
docker network connect --ip 10.3.12.2 net-r3-r12 r12
